                    ...
                    [
                      {
                        icon: (
                          <div className="w-8 h-8 bg-pink-100 rounded-full flex items-center justify-center mr-3">
                            <div className="w-0 h-0 border-l-2 border-r-2 border-b-3 border-transparent border-b-pink-600"></div>
                          </div>
                        ),
                    ...
                    [
                      {
                        icon: (
                          <div className="w-8 h-8 bg-pink-100 rounded-full flex items-center justify-center mr-3">
                            <div className="w-4 h-4 bg-pink-600 rounded-full border-2 border-pink-400 relative">
                              <div className="absolute inset-1 bg-pink-100 rounded-full"></div>
                            </div>
                          </div>
                        ),
